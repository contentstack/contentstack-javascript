 ...
 /**
    ...
    includeReference(...val) {
        if (Array.isArray(val) || typeof val === "string") {
            ...
            if (this.fetchOptions.debugger)  this.fetchOptions.logHandler('error', "Argument should be a String or an Array.");
        }
    }
    ...
    language(language_code) {
        if (language_code && typeof language_code === 'string') {
            ...
            if (this.fetchOptions.debugger)  this.fetchOptions.logHandler('error', "Argument should be a String.");
        }
    }
    ...
    addQuery(key, value) {
        if (key && value && typeof key === 'string') {
            ...
            if (this.fetchOptions.debugger)  this.fetchOptions.logHandler('error', "First argument should be a String.");
        }
    }
   ...
   /**
    ...
    addParam(key, value) {
        if (key && value && typeof key === 'string' && typeof value === 'string') { 
            ...
            if (this.fetchOptions.debugger)  this.fetchOptions.logHandler('error', "Kindly provide valid parameters.");
        }
    }
    ...
    fetch(fetchOptions) {
        ...
        if (this.entry_uid) {
            ...
            if (this.fetchOptions.debugger)  this.fetchOptions.logHandler('error', "Kindly provide an entry uid. e.g. .Entry('asset_uid')");
        }
    }
}