...
var _result = __webpack_require__(44);
...
function sendRequest(queryObject) {
    ...
    */
    ...
    if (cachePolicy === 3) {
        console.log("resllllllllll", self.provider);
        /////// New Implementaion 
        // return new Promise(function(resolve, reject) {
        //     // if (self.provider !== null) {
        //         self.provider.get(hashQuery, function(err, _data) {
...
var Stack = function () {
    ...
    _createClass(Stack, [{
        ...
        */
        ...
        key: 'getAllContentTypes',
        value: function getAllContentTypes() {
            var query = {
                method: 'POST',
                headers: this.headers,
                url: this.config.protocol + "://" + this.config.host + ':' + this.config.port + '/' + this.config.version + this.config.urls.content_types,
        ...
        */
        ...
        key: 'getContentType',
        value: function getContentType(content_type_uid) {
            var query = {
                method: 'POST',
                headers: this.headers,
...
var convert = __webpack_require__(19).convert;
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__(8).concat(__webpack_require__(16));
        }
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__(15).concat(__webpack_require__(48));
        },
...
var modules = [__webpack_require__(25), __webpack_require__(29), __webpack_require__(30), __webpack_require__(26), __webpack_require__(28), __webpack_require__(27), __webpack_require__(22), __webpack_require__(23)];
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings) iconv.encodings = __webpack_require__(24); // Lazy load all encoding definitions.
...
var realFetch = __webpack_require__(38);
